...
% 	\end{minipage}
% 	\begin{minipage}{.3\dropbox}
% 		\includeFigure{1}{login}{Choisir un compte Dropbox.}
% 	\end{minipage}
% 	\begin{minipage}{.3\textwidth}
% 		\includeFigure{1}{choose_master_password}{Créer la session TODO mettre le nom de la session et le Master Password qui la chiffrera.}
% 	\end{minipage}        
% \end{center}
...
%	\end{minipage}
%	\begin{minipage}{.5\textwidth}
%		\includeFigure{1}{TODO}{Ouvre la session TODO mettre le nom de la session (ou une autre session selectionée par l'utilisateur) à l'aide du Master Password.}
%	\end{minipage}        
%\end{center}
...
%	\end{minipage}
%	\begin{minipage}{.3\dropbox}
%		\includeFigure{1}{TODO}{Création d'un nouveau compte.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Générer un mot de passe.}
%	\end{minipage}        
%\end{center}
...
%	\end{minipage}
%	\begin{minipage}{.3\dropbox}
%		\includeFigure{1}{TODO}{Pannel lorsqu'un compte est sélectionné. Les options sont grisées lorsque les informations sont vides.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Raccourcis permmettant de voir le mot de passe d'un compte.}
%	\end{minipage}        
%\end{center}
...
%\begin{center}
%	\begin{minipage}{.5\textwidth}
%		\includeFigure{1}{TODO}{Les détails du compte.}
%	\end{minipage}
%	\begin{minipage}{.5\textwidth}
%		\includeFigure{1}{TODO}{Ecran d'édition du compte.}
%	\end{minipage}        
%\end{center}
...
%\begin{center}
%	\begin{minipage}{.5\textwidth}
%		\includeFigure{1}{TODO}{Exemple de suppression d'un compte.}
%	\end{minipage}
%	\begin{minipage}{.5\textwidth}
%		\includeFigure{1}{TODO}{Affichage du bouton Undo pour annuler la dernière modification.}
%	\end{minipage}        
%\end{center}
...
%\begin{center}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Option de tri de la liste principale.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Option de recherche.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Mettre un compte dans les favoris.}
%	\end{minipage}        
%\end{center}
...
%\begin{center}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Chargement de la dernière session locale sauvegardée.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Une icône en rouge est affichée lorsqu'il n'y a plus de réseau.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Les actions d'éditions sont désactivées.}
%	\end{minipage}        
%\end{center}
...
% exemple 1 figure
%\includeFigure{.5}{TODO}{Force la synchronisation de la session locale avec la session sauvée sur Dropbox.}
...
%\begin{center}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Settings de l'application.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Edition de la liste des caractères spéciaux.}
%	\end{minipage}
%	\begin{minipage}{.3\textwidth}
%		\includeFigure{1}{TODO}{Edition du master password.}
%	\end{minipage}        
%\end{center}
